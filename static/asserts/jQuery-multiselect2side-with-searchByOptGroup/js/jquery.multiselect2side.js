        ...
        init: function (options) {
            ...
            return this.each(function () {
                ...
                var fto = function () {
                    ...
                    if (o.searchByOptGroup == true && o.optGroupSearch != false && lastOptGroupSearch != false && lastOptGroupSearch != '__null__') {
                        var toSearch = el.find("optgroup[label='" + lastOptGroupSearch + "']").find("option:not(:selected)");
                    } else {
