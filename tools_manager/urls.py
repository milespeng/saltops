    ...
    url(r'^tools_types_list/', include([
        ...
        url(r'$', simple_list),
            ...
            'args': {
                ...
                'template_path': 'tools_manager/tools_types_list.html',
                'add_title': '新增工具类型',
    ...
    url(r'^tools_script_list/', include([
        ...
        url(r'$', simple_list),
            ...
            'args': {
                ...
                'template_path': 'tools_manager/tools_script_list.html',
                'plugin_name': 'tool_script_list_plugin',
                'form_template_path': 'tools_manager/tools_script_form.html',
                'add_title': '新增工具',
