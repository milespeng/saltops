# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-08-17 15:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enable_tty', models.BooleanField(choices=[(True, '启用'), (False, '禁用')], default=False, verbose_name='启用TTY')),
                ('cabinet', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cmdb.Cabinet', verbose_name='机柜')),
            ],
            options={
                'verbose_name': '主机',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cabinet', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cmdb.Cabinet', verbose_name='机柜')),
                ('idc', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cmdb.IDC', verbose_name='机房')),
            ],
            options={
                'verbose_name': '机架',
