    ...
    url(r'^project_module_list/', include([
        ...
        url(r'$', simple_list),
            ...
            'args': {
                ...
                'template_path': 'deploy_manager/project_module_list.html',
                'add_title': '新增业务模块',
    ...
    url(r'^project_list/', include([
        ...
        url(r'$', simple_list),
            ...
            'args': {
                ...
                'form_template_path': 'deploy_manager/project_form.html',
                'template_path': 'deploy_manager/project_list.html',
                'add_title': '新增业务',
